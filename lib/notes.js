...
//function used to find the id value of each note. this function is required in order to successfully delete the correct note from the array.
function findById(id, notesArray) {
    const result = notesArray.filter(notes => notes.id === id)[0];
    return result;
}

module.exports = { createNote, validateNote, findById };
